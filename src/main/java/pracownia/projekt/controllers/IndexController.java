...
public class IndexController {
    ...
    public String generateModel() {
        ...
        Employee employee3 = new Employee(3, "Juan", "Cruz", 7, "realizm", "236773334", "Kołobrzeg", "Mózgowa 20");
        Tattoo tattoo1 = new Tattoo(1, "Pająk", null, "średni", "czarny", new BigDecimal("80.45"));
        Tattoo tattoo2 = new Tattoo(2, "Róża", "z cierniami", "duży", "zielony, czerwony", new BigDecimal("50.70"));
        Tattoo tattoo3 = new Tattoo(3, "Gwiazda", null, "mały", "czarny", new BigDecimal("20.00"));
        ...
        Order order1 = new Order(1, employee1, client3, tattoo3, "ręka");
